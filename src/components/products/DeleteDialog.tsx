...
export function DeleteDialog({ open, productName, onClose, onConfirm }: Props) {
    ...
    >
      ...
      <DialogContent>
        <Typography sx={{ fontSize: 14, color: dark ? "#94A3B8" : "#64748B" }}>
          Are you sure you want to delete <strong style={{ color: dark ? "#F1F5F9" : "#1E293B" }}>{productName}</strong>? This action cannot be undone.
        </Typography>
      </DialogContent>
